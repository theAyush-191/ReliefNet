...
struct DoctorHomeView: View {
    ...
    @State var data : [DoctorSession]=Sessions.sampleSession
    var doctor: Doctor {
...
//                            .foregroundColor(.blue)
                    ...
                    LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 16) {
                        ...
                        NavigationLink(destination: DoctorAppointmentView(sessions:$data)) {
                            QuickCardView(title: "Appointments", icon: "calendar.badge.clock", color: .blue)
                        }

                        NavigationLink(destination: NewAppointmentsView(sessions:$data)) {
                            QuickCardView(title: "New Requests", icon: "bell.fill", color: .orange)
                        }
...
//#Preview{
//    DoctorHomeView().environmentObject(UserSession())
//}
